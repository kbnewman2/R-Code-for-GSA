R Code for carrying out several types of Global Sensitivity Analysis (GSA) on deterministic simulators. GSA methods include Morris Elementary Effects, Sobol' sensitivities, VARS-TO variogram method, and several regression-based methods.

Currently two simulators, GR6J and SimplyP.  Wihin each folder, download the R code and the data files to your computer. For each simulator user needs to create a folder, GR6J, then 3 subfolders: R Code, Data, and Output. Likewise for SimplyP.  
